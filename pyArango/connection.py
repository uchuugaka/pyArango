...
class JsonHook(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        except Exception as e:  # ALWAYS USE A SPECIFIC Exception or Tuple of them!
...
class AikidoSession(object):
    ...
    def __init__(self, username, password):
        """Init AikidoSession with username and password."""
        if username:
...
class Connection(object):
    ...
    def createDatabase(self, name, **dbArgs):
        """Create database named 'name' using dbArgs for arguments other than name.

        For a full list of arguments please have a look at ArangoDB's docs.
        """
        dbArgs['name'] = name
    ...
    def hasDatabase(self, name):
        """Return True if the connection has a database named 'name', otherwise False."""
